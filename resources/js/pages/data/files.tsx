...
export default function DataFiles({ importFiles, exportFiles, userRole }: Props) {
                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Manage your import and export files</p>
                        </div>
                    </div>
                </div>
                            ...
                            <CardHeader>
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <CardDescription>Files uploaded for importing users</CardDescription>
                                    </div>
                                    <Button asChild>
                            ...
                            <CardContent>
                                {importFiles.length > 0 ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center py-12 text-center">
                                        ...
                                        <p className="text-sm text-muted-foreground">Upload your first import file to get started</p>
                                    </div>
                                )}
                            </CardContent>
                        </Card>
                        ...
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <CardDescription>
                                        {userRole === 'super_admin' ? 'Your exported files' : 'Files you have exported'}
                                    </CardDescription>
                                </div>
                                <Button asChild>
                        ...
                        <CardContent>
                            {exportFiles.length > 0 ? (
                                ...
                                <div className="flex flex-col items-center justify-center py-12 text-center">
                                    ...
                                    <p className="text-sm text-muted-foreground">Export your first file to get started</p>
                                </div>
                            )}
                        </CardContent>
                    </Card>
