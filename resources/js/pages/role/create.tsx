...
export default function CreateRole({ permissions, availableRoles }: Props) {
    const [usePresetRole, setUsePresetRole] = useState(false);
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-center space-x-2">
                                <Checkbox
                                    ...
                                    onCheckedChange={(checked) => setUsePresetRole(checked as boolean)}
                                />
                                <Label htmlFor="use-preset">Use predefined role template</Label>
                            </div>

                            {usePresetRole && (
                                <div className="space-y-2">
                                    <Label htmlFor="preset-role">Select Role Template</Label>
                                    <select
                                        id="preset-role"
